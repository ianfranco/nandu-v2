...
import com.areatecnica.sigf.dao.impl.IEgresoGuiaDaoImpl;
...
public class RecaudacionGuiaController extends AbstractController<Guia> {
    ...
    private IEgresoGuiaDao egresoGuiaDao;
    ...
    public void init() {
        ...
        if (this.cajaRecaudacion != null) {
            ...
            System.err.println("CANTIDAD DE PROCESOS ASOCIADOS A LA CAJA:"+this.cajaRecaudacion.getCajaRecaudacionNombreCaja()+" ("+cajaProcesoList.size()+")");
    ...
    private List<EgresoGuia> egresosGuia(Guia guia) {
        ...
        for (Egreso e : this.egresosList) {
            ...
            if (e.getEgresoActivo()) {
                ...
                egresoGuia.setEgresoGuiaIdCajaRecaudacion(cajaRecaudacion);
    ...
    public void load() {
        ...
        this.egresoGuiaDao = new IEgresoGuiaDaoImpl();
        //this.egresoGuiaList = this.
    ...
    public void findFolio() {
        if (this.getSelected() != null) {
            ...
            if (auxGuia == null) {
                JsfUtil.addExclamationMessage("Se ingresará una nueva Guía");
                this.getSelected().setGuiaFecha(fechaRecaudacion);
            }
        }
    }
